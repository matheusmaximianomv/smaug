...
export class UpdateOneTimeRevenueUseCase {
  ...
  public async execute(input: UpdateOneTimeRevenueInput): Promise<OneTimeRevenue> {
...
export class RevenueNotFoundError extends DomainError {
  public readonly code = "REVENUE_NOT_FOUND";
...
export class PastCompetenceEditError extends DomainError {
